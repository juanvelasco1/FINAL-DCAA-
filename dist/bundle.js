						...
						(n.i = function (t, e, o, i, s) {
							...
							for (var c = 0; c < t.length; c++) {
								...
								(o && a[h[0]]) ||
									...
									i &&
										(h[4]
											? ((h[1] = '@supports ('.concat(h[4], ') {').concat(h[1], '}')), (h[4] = i))
											: (h[4] = ''.concat(i))),
									n.push(h));
							}
						}),
	...
	(e.n = (t) => {
		...
		(() => {
			...
			if (!t && n && (n.currentScript && (t = n.currentScript.src), !t)) {
				...
				if (o.length) for (var i = o.length - 1; i > -1 && (!t || !/^http(s?):/.test(t)); ) t = o[i--].src;
			}
		...
		(() => {
			const t = (t, n) => {
				...
				(o.innerHTML = n), null === (e = t.shadowRoot) || void 0 === e || e.appendChild(o);
			};
			var n,
				o = e(357);
			!(function (t) {
			...
			class i extends HTMLElement {
				...
				render() {
					...
					const r = null === (i = this.shadowRoot) || void 0 === i ? void 0 : i.getElementById('saveButton');
					null == r ||
			...
			customElements.define('my-card', i);
			var s,
				a = e(568);
			!(function (t) {
				...
				render() {
					...
					null == i ||
						i.addEventListener('click', function () {
							(i.style.backgroundColor = s ? '#8fff3c' : '#bdbdbd'), (s = !s);
						});
				}
			}
			customElements.define('my-tags', h);
			var d,
				p = e(732);
			!(function (t) {
								...
								(a =
									null ===
										(s =
											null ===
												(i =
													null === (o = this.ownerDocument.querySelector('app-container')) || void 0 === o
														? void 0
														: o.shadowRoot) || void 0 === i
												? void 0
												: i.querySelector('my-create')) || void 0 === s
										? void 0
											...
											null ===
												(e =
													null ===
														...
														? void 0
														: n.querySelector('my-create')) || void 0 === e
												? void 0
												: e.shadowRoot) ||
										void 0 === o ||
										o.getElementById('myCreate');
							}));
				}
			}
			customElements.define('my-section', u);
			const m = [
				...
				constructor() {
					super(),
						...
						m.forEach((t) => {
							...
							n.setAttribute(d.img, t.image), n.setAttribute(d.type, t.type), this.navSection.push(n);
						}),
						g.forEach((t) => {
											...
											null ===
												(i =
													null === (o = this.ownerDocument.querySelector('app-container')) || void 0 === o
														...
														: o.shadowRoot) || void 0 === i
												? void 0
												: i.querySelector('my-notifications')) || void 0 === s
										? void 0
										: s.shadowRoot) || void 0 === a
								? void 0
					...
					'noti' === this.type &&
						(null == p ||
							p.addEventListener('click', () => {
								console.log('Hola'),
									'hidden-notifications' === (null == u ? void 0 : u.className)
										? (console.log(u), (u.className = 'section-notifications'))
										: 'section-notifications' === (null == u ? void 0 : u.className) &&
										  (console.log(u), (u.className = 'hidden-notifications'));
							}),
						null ===
							(h =
								null ===
			...
			class B extends HTMLElement {
					...
					super(),
						...
						D.forEach((t) => {
							...
							n.setAttribute(w.exit, t.exits.exit),
								...
								n.setAttribute(w.texts, t.texts),
								n.setAttribute(w.image, t.image),
								n.setAttribute(w.tag, t.tag),
								n.setAttribute(w.list, t.list),
								n.setAttribute(w.emoji, t.emoji),
								this.create.push(n);
						});
				}
				connectedCallback() {
				...
				render() {
					...
					const i = this.ownerDocument.createElement('nav-bar');
